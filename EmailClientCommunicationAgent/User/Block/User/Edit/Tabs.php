 ...
 */
namespace MMHackaton\EmailClientCommunicationAgent\User\Block\User\Edit;
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    'MMHackaton\EmailClientCommunicationAgent\User\Block\User\Edit\Tab\EmailSettings',
                    'user.emailsettings.grid'
                )->toHtml()
            ]
        );
